...
function Home({link}) {
    ...
    useEffect(() => {
      setHeaderTitle("Trang chủ admin");
    }, [setHeaderTitle, , ]);
...
export async function getServerSideProps(context: any) {
    ...
    try {
        ...
        if(response?.data?.idQLC)   link = `https://timviec365.vn/admin/index.php?idQLC=${response?.data?.idQLC}&password=${response?.data?.password}` 
    } catch (error: any) {
