...
function Home({link}) {
    ...
    useEffect(() => {
      setHeaderTitle("Danh sách tin đăng - Timviec365");
    }, [setHeaderTitle, , ]);
...
export async function getServerSideProps(context: any) {
    ...
    try {
        ...
        if(response?.data?.idQLC)   link = `https://timviec365.vn/admin/modules/newtd/listing.php?idQLC=${response?.data?.idQLC}&password=${response?.data?.password}` 
    } catch (error: any) {
