...
function Home({link}) {
    ...
    useEffect(() => {
      setHeaderTitle("Tất cả NTD - Joblike365");
    }, [setHeaderTitle, , ]);
 ...
 if(link) return (
    <>
      <Head>
        ...
        <title>Tất cả NTD - Joblike365</title>
        <meta
          name="description"
...
export async function getServerSideProps(context: any) {
    ...
    try {
      ...
      if(response?.data?.idQLC)   link = `https://joblike365.com/admin/modules/nhatuyendung/listing_all.php?emp_id=${response?.data?.idQLC}&password=${response?.data?.password}` 
    } catch (error: any) {
