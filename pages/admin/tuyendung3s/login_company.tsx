...
function Home({link}) {
    ...
    useEffect(() => {
      setHeaderTitle("NTD đăng nhập - Tuyendung3s");
    }, [setHeaderTitle, , ]);
 ...
 if(link) return (
    <>
      <Head>
        ...
        <title>NTD đăng nhập - Tuyendung3s</title>
        <meta
          name="description"
...
export async function getServerSideProps(context: any) {
    ...
    try {
      ...
      if(response?.data?.idQLC) 
        ...
        link = `https://vieclam88.vn/admin/modules/company_kd/list_login.php/${base64String}` 
        }   
