...
import ZaloFormProduct from "@/components/crm/marketing/zalo/zalo_form_product";
import { useRouter } from "next/router";

const AddProductZalo: React.FC = () => {
    const router = useRouter()
    const category_id = router.query?.category_id || 0
    ...
    useEffect(() => {
        setHeaderTitle("Zalo / Zalo shop / Thêm sản phẩm");
    ...
    return (
        <>
            ...
            <div className={styleHome.main} ref={mainRef}>
                <ZaloFormProduct type={'add'} category_id={Number(category_id)} />
            </div>
        </>
    );
};

export default AddProductZalo;
