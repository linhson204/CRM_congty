...
export default function PostPersonal() {
    ...
    return (
        <>
                                        ...
                                        <div className={`${style.postInputContainer} ${style.BlockColumn}`}>
                                            <div className={`${style.BlockRow}`}>
                                                ...
                                                <div className={`${style.BlockColumn}`}>
                                                    <div className={style.postGrName}>{savedData.account.name}</div>
                                                ...
                                                <div key={post.id} className={style.postItem}>
                                                    <div className={style.BlockRow} style={{marginBottom: '15px'}}>
                                                        <div className={style.postHeader}>
                                                            ...
                                                            <div>
                                                                <div className={style.postUserName}>{savedData.account.name}</div>
            ...
            <LoadingDialog show={showLoading} message="Đang đăng bài..." onClose={() => setShowLoading(false)} />
        </>
    );
}