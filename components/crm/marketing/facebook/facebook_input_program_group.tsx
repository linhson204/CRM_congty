...
const FacebookInputProgramGroup: React.FC<InputProps> = ({ page }) => {
  let changePage = 'xem-truoc-kich-ban-nhom'
...
export default FacebookInputProgramGroup;
