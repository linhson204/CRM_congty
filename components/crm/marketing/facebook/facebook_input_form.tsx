...
const FacebookInput: React.FC<InputProps> = ({ page }) => {
    const changePage = 'xem-truoc-kich-ban-ket-ban'
  ...
  return (
    <div className={styles.facebook__fillter}>
      ...
      { page === "xem-truoc-kich-ban-ket-ban" && 
      ...
      { page === "mau-tin-nhan-truyen-thong" && 
        <div className={`${styles.btn_facebook_kich_ban} ${page === "mau-tin-nhan-truyen-thong" && styles.btn_full  }`}>
          <button className={`${styles.btn_input} ${page === 'mau-tin-nhan-truyen-thong' && styles.btn_full  }`}>Gửi tin nhắn</button>
        </div>
      }
    </div>
  );
