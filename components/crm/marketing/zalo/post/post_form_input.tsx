...
import GroupModal from "../group/group_modal";
...
export default function GroupFormInputGroup({ isSelectedRow, changeValueInput }: GroupFormInputProps) {
    ...
    <div className={styles.main__control}>
      <div className={`${styles.main__control_btn} flex_between`}>
        <div className={styles.main__control_search}>
          <form onSubmit={() => false}>
            <input
              ...
              onChange={(value) => changeValueInput(value.target.value)}
            />
        ...
        <div className={`${styles.main__control_add} flex_end `}>
            <button
              type="button"
              className={`${styles.dropbtn_add} flex_align_center ${stylePost.custom_bg_btn}`}
              onClick={async() => await router.push("post/post-add")}
            >
                 <svg
              ...
              <p>
              <span className={styles.hidden_mobile}>Thêm lệnh đăng bài</span>
              </p>
