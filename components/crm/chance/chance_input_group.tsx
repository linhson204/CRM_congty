...
import styleCampaignInput from "../../crm/campaign/campaign.module.css";
...
import PotentialAction from "../potential/potential_action";
import ChanceHeaderActionDropDown from "./chance_header_action";
  ...
  return (
    <div className={styleCampaignInput.main__control}>
      ...
      >
        ...
        <div style={{ minWidth: "50%" }} className="user_custom_select2">
          <select
