...
import OrderaDropDown from "./order_new_dropdown";
export default function OrderNewSelect({ title = "", value = "Tất cả" }) {
    ...
    return (
        ...
        >
            ...
            >
                ...
                {isOpen && <OrderaDropDown valueSelect={valueSelect} setValueSelect={setValueSelect} />}
            </span>
        </div>
    );
}
