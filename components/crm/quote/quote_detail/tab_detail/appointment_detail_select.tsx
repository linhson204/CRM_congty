...
import AppointmentDetailDropDown from "./appointment_detail_dropdown";
export default function AppointmentDetailSelectBox({ title = "", value = "Tất cả", setValue = (value) => { }, num = 0 }) {
  ...
  const status = [
    { key: 0, value: "Tất cả" },
    { key: 1, value: "Hoàn thành" },
    { key: 2, value: "Chờ thực hiện" },
    { key: 3, value: "Chưa liên hệ được" },
    { key: 4, value: "Đã hủy" },
    { key: 5, value: "Hoàn thành muộn" },
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isOpen && <AppointmentDetailDropDown valueSelect={valueSelect} setValueSelect={setValueSelect} />}
      </span>
    </div>
  );
}
