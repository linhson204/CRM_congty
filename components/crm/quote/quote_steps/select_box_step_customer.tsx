...
export default function CustomerSelectBoxStep({
  ...
  const { setShouldFetchCus, listCusOption, shouldFetchCus } = useContext(QuoteContext)
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isOpen && <CustomerDropDownDataStep data={data} value={value} setValue={setValue} setKeyword={setKeyword} keyword={keyword} />}
      </span>
      {isLoading && isOpen ? (
        <Spin
          style={{
