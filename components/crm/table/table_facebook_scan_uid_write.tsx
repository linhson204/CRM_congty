...
interface TableDataFacebookScanUIDWrite {
...
const TableDataFacebookScanWrite: React.FC<TableDataFacebookScanUIDWrite> = ({ setSelected, openModallOtpAcc, setOpenModalOtpAcc, setOpenModalDel, setOpenModalUpdate }: any) => {
...
export default TableDataFacebookScanWrite;
