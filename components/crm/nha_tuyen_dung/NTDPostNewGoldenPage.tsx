...
const NTDPostNewGoldenPage = (props: Props) => {
    ...
    const [condition, setCondition] = useState(() => {
        ...
        query['page'] = current;
        query['perPage'] = 10;
        query['original_from'] = 'golden_page_post';
    ...
    const handleExportDataStaff = () => {
        ...
        const getData = async () => {
            ...
            let nameFile = `Danh sách chia giỏ nhà tuyển dụng đăng tin(topcv).xlsx`;
    ...
    const handleExportDataCustomer = () => {
        ...
        const getData = async () => {
            ...
            let nameFile = `Danh sách nhà tuyển dụng đăng tin topcv.xlsx`;
            downloadExcel(data_final,nameFile);
        };
        getData();
...
export default NTDPostNewGoldenPage;
